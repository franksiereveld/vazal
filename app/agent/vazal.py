...
SYSTEM_PROMPT = (
    ...
    "   - PRESENTATION GUIDELINES (HARDCODED & ENFORCED):\n"
    "     1. MINIMUM 5 SLIDES: You MUST create at least 5 slides (Title + Summary + 2 Content + Conclusion).\n"
    "     2. SLIDE 2 = SUMMARY: Must be titled 'Executive Summary', 'Agenda', or 'Table of Contents'.\n"
    "     3. LAST SLIDE = CONCLUSION: Must be titled 'Conclusion', 'Next Steps', or 'Future Outlook'.\n"
