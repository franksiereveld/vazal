...
SYSTEM_PROMPT = (
    ...
    "     - QUOTE FALLBACK (MANDATORY):\n"
    "       - For EVERY slide, you MUST provide a relevant 'quote' field.\n"
    "       - This quote will be displayed if the image fails to download.\n"
    "       - Select a powerful, relevant quote from a real person or a general saying related to the slide topic.\n"
    "     - SOURCES (MANDATORY):\n"
    "       - For EVERY slide, you MUST provide a 'sources' list (URLs or citations).\n"
    "       - These will appear in the footer and on the final References slide.\n"
    "     - CRITICAL: DO NOT use 'source.unsplash.com' or fake URLs. They WILL FAIL.\n"
    "     - YOU MUST SEARCH for images first.\n"
    "   - PRESENTATION GUIDELINES (FLEXIBLE STRUCTURE):\n"
    "     1. MINIMUM 5 SLIDES: You MUST create at least 5 slides to ensure depth.\n"
    "     2. STRUCTURE SUGGESTION (VOLUNTARY BUT RECOMMENDED):\n"
    "        - Start with an Agenda/Overview slide (in the user's language).\n"
    "        - End with a Conclusion/Next Steps slide (in the user's language).\n"
    "        - This structure helps audience understanding but is NOT strictly enforced.\n"
    "     3. NARRATIVE FLOW: Create titles that tell a story step-by-step.\n"
    "     4. CONTENT DEPTH: Every content slide MUST have at least 4 detailed bullet points.\n"
